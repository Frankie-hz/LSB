...
-- Notes: FFO wiki lists the mob version Drown at -14 HP/3s; BLU spell version is fTP 2.25.
...
abilityObject.onPetAbility = function(target, pet, petskill, owner, action)
    ...
    if xi.mobskills.processDamage(pet, target, petskill, action, info) then
        ...
        xi.mobskills.mobStatusEffectMove(pet, target, xi.effect.DROWN, 14, 3, 60)
    end
