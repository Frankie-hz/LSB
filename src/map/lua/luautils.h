...
// triggers when an instance is created or failed to load (per character - waiting outside for entry)
void OnInstanceCreatedCallback(CCharEntity* PChar, uint32 instanceId, CInstance* PInstance);
